...
#### What's New
- Basic Tasker integration for safely starting SoundWave's service
...
#### What's Changed
- Ignore MediaStore tags is now SoundWave's default and unchangeable behavior. The option has been removed.
...
- SoundWave has a new, more refined icon style
...
- Massively overhauled how music is loaded [#72]:
	- SoundWave can now reload music without requiring a restart
...
- Fixed issue where apps like GadgetBridge would not detect SoundWave
...
## v2.0.0
#### What's New:
- SoundWave has a new look derived from Material 3
...
- Loading screen has been tweaked to line up with the rest of SoundWave
