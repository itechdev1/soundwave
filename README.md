...
<h1 align="center"><b>SoundWave</b></h1>
<h4 align="center">A simple, rational music player for Android.</h4>
<p align="center">
    <a href="https://github.com/oxygencobalt/SoundWave/releases/tag/v4.0.10">
        <img alt="Latest Version" src="https://img.shields.io/static/v1?label=tag&message=v4.0.10&color=64B5F6&style=flat">
    </a>
    <a href="https://github.com/oxygencobalt/SoundWave/releases/">
        <img alt="Releases" src="https://img.shields.io/github/downloads/OxygenCobalt/SoundWave/total.svg?color=4B95DE&style=flat">
    </a>
...
<h4 align="center"><a href="/CHANGELOG.md">Changelog</a> | <a href="https://github.com/OxygenCobalt/SoundWave/wiki">Wiki</a> | <a href="https://github.com/OxygenCobalt/SoundWave#Donate">Donate</a></h4>
<p align="center">
    <a href="https://f-droid.org/app/com.itech.soundwave"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on.png" width="250"></a>
    <a href="https://accrescent.app/app/com.itech.soundwave">
        <img alt="Get it on Accrescent" src="https://accrescent.app/badges/get-it-on.png" width="250">
    </a>
</p>
<p align="center">
    <a href="https://hosted.weblate.org/engage/SoundWave/"><img height=64 src="https://hosted.weblate.org/widgets/SoundWave/-/strings/287x66-grey.png" alt="Translation status" /></a>
</p>

## About

SoundWave is a local music player with a fast, reliable UI/UX without the many useless features present in other music players. Built off of modern media playback libraries, SoundWave has superior library support and listening quality compared to other apps that use outdated Android functionality. In short, **It plays music.**
...
You can support SoundWave's development through [my Github Sponsors page](https://github.com/sponsors/OxygenCobalt). Get the ability to prioritize features and have your profile added to the README, Release Changelogs, and even the app itself!
...
SoundWave relies on a patched version of Media3 that enables some extra playback features, alongside taglib for metadata
...
SoundWave should now appear in the list of Apps

#### Load music to SoundWave (Optional)
...
SoundWave accepts most contributions as long as they follow the [Contribution Guidelines](/.github/CONTRIBUTING.md).

However, feature additions and major UI changes are less likely to be accepted. See
[Why Are These Features Missing?](https://github.com/OxygenCobalt/SoundWave/wiki/Why-Are-These-Features-Missing%3F)
...
SoundWave is Free Software: You can use, study share and improve it at your
will. Specifically you can redistribute and/or modify it under the terms of the
[GNU General Public License](https://www.gnu.org/licenses/gpl.html) as
published by the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

More information can be found [here](https://github.com/OxygenCobalt/SoundWave/wiki/Licenses).
