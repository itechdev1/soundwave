/*
 * Copyright (c) 2026 SoundWave Project
 * SoundWaveToolbar.kt is part of SoundWave.
 *
...
import com.itech.soundwave.databinding.ViewToolbarBinding
...
constructor(
    ...
    private fun createActionButtonContext(itemId: Int): Context {
        val themeOverlayRes =
            when (itemId) {
                R.id.action_play -> R.style.ThemeOverlay_SoundWave_IconButton_Style_Small_Secondary
                R.id.action_shuffle -> R.style.ThemeOverlay_SoundWave_IconButton_Style_Small_Primary
                else -> 0
            }
