 ...
 * BasePreferenceFragment.kt is part of SoundWave.
 *
...
import com.itech.soundwave.settings.ui.IntListPreference
import com.itech.soundwave.settings.ui.IntListPreferenceDialog
import com.itech.soundwave.settings.ui.PreferenceHeaderItemDecoration
...
abstract class BasePreferenceFragment(@XmlRes private val screen: Int) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<SoundWaveToolbar>(R.id.preferences_toolbar).apply {
