 ...
 * MediaButtonReceiver.kt is part of SoundWave.
 *
...
import com.itech.soundwave.SoundWaveService
...
class MediaButtonReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (playbackManager.currentSong != null) {
            ...
            intent.component = ComponentName(context, SoundWaveService::class.java)
            intent.putExtra(SoundWaveService.INTENT_KEY_START_ID, IntegerTable.START_ID_MEDIA_BUTTON)
