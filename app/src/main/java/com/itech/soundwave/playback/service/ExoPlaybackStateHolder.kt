 ...
 * ExoPlaybackStateHolder.kt is part of SoundWave.
 *
...
import com.itech.soundwave.image.ImageSettings
import com.itech.soundwave.music.MusicRepository
import com.itech.soundwave.playback.PlaybackSettings
import com.itech.soundwave.playback.persist.PersistenceRepository
import com.itech.soundwave.playback.replaygain.ReplayGainAudioProcessor
import com.itech.soundwave.playback.state.DeferredPlayback
import com.itech.soundwave.playback.state.PlaybackCommand
import com.itech.soundwave.playback.state.PlaybackStateHolder
import com.itech.soundwave.playback.state.PlaybackStateManager
import com.itech.soundwave.playback.state.Progression
import com.itech.soundwave.playback.state.RawQueue
import com.itech.soundwave.playback.state.RepeatMode
import com.itech.soundwave.playback.state.ShuffleMode
import com.itech.soundwave.playback.state.StateAck
...
class ExoPlaybackStateHolder(
    ...
    constructor(
        ...
        fun create(): ExoPlaybackStateHolder {
            // Since SoundWave is a music player, only specify an audio renderer to save
