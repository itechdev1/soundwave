 ...
 * PlaybackServiceFragment.kt is part of SoundWave.
 *
...
import com.itech.soundwave.SoundWaveService.Companion.INTENT_KEY_START_ID
...
import com.itech.soundwave.widgets.WidgetComponent
        ...
        val action =
            when (startId) {
                ...
                IntegerTable.START_ID_MEDIA_BUTTON -> {
                    ...
                    // External services using SoundWave better know what they are doing.
