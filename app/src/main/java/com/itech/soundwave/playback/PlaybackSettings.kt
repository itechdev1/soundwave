 ...
 * PlaybackSettings.kt is part of SoundWave.
 *
...
import com.itech.soundwave.playback.replaygain.ReplayGainMode
import com.itech.soundwave.playback.replaygain.ReplayGainPreAmp
import com.itech.soundwave.settings.Settings
...
class PlaybackSettingsImpl @Inject constructor(@ApplicationContext context: Context) :
    ...
    private companion object {
        const val OLD_KEY_LIB_MUSIC_PLAYBACK_MODE = "SoundWave_library_playback_mode"
        const val OLD_KEY_DETAIL_MUSIC_PLAYBACK_MODE = "SoundWave_detail_playback_mode"
    }
}
