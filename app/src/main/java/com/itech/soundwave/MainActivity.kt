 ...
 * MainActivity.kt is part of SoundWave.
 *
...
import com.itech.soundwave.databinding.ActivityMainBinding
...
/**
 * SoundWave's single [AppCompatActivity].
 *
 * @author iTECH
 *
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        startService(
            Intent(this, SoundWaveService::class.java)
                .setAction(SoundWaveService.ACTION_START)
                .putExtra(SoundWaveService.INTENT_KEY_START_ID, IntegerTable.START_ID_ACTIVITY)
        )
    ...
    private fun startIntentAction(intent: Intent?): Boolean {
        ...
        val action =
            when (intent.action) {
                ...
                SoundWave.INTENT_KEY_SHORTCUT_SHUFFLE -> DeferredPlayback.ShuffleAll
                else -> {
