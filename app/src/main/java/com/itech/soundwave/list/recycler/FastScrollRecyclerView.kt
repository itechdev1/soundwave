 ...
 * FastScrollRecyclerView.kt is part of SoundWave.
 *
...
import com.itech.soundwave.ui.ExpressiveShapes
import com.itech.soundwave.ui.Spatial
import com.itech.soundwave.util.getAttrColorCompat
import com.itech.soundwave.util.getAttrResourceId
import com.itech.soundwave.util.getDimenPixels
import com.itech.soundwave.util.inflater
import com.itech.soundwave.util.isRtl
import com.itech.soundwave.util.isUnder
import com.itech.soundwave.util.scale
 ...
 * Hai Zhang's AndroidFastScroll but slimmed down for SoundWave and with a couple of enhancements.
 *
 ...
 * - Use modified SoundWave resources instead of AFS resources
 ...
 * - Dynamic popups
 *
 * @author Hai Zhang, iTECH
 */
class FastScrollRecyclerView
@JvmOverloads
constructor(context: Context, attrs: AttributeSet? = null, @AttrRes defStyleAttr: Int = 0) :
    SoundWaveRecyclerView(context, attrs, defStyleAttr) {
    // Thumb
