 ...
 * SoundWave.kt is part of SoundWave.
 *
...
import com.itech.soundwave.home.HomeSettings
...
import com.itech.soundwave.util.CopyleftNoticeTree
...
class SoundWave : Application() {
    ...
    override fun onCreate() {
        ...
        if (
            BuildConfig.APPLICATION_ID != "com.itech.soundwave" &&
                BuildConfig.APPLICATION_ID != "com.itech.soundwave.debug"
        ) {
