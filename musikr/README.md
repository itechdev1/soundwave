...
Musikr is a highly opinionated multithreaded music loader that enables SoundWave's advanced music functionality.
...
Feel free to use this library as long as you follow SoundWave's GPLv3 license. Note that the license is viral, so
